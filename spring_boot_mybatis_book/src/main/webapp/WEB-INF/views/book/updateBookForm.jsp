...
<html>
	...
	<body>
		...
		<form method="post" action="<c:url value='/book/updateBook'/>">
			<table>
				<tr><td>도서번호</td>
					<td><input type="text" name="bookNo" id="bookNo" value="${book.bookNo }" readonly>
				<button id="prdNoCheckBtn" name="prdNoCheckBtn">중복확인</button></td></tr>
				<tr><td>도서명</td>
		...
		<a href="<c:url value='/book/listAllBook'/>">[전체 상품 조회]</a><br>
	</body>
</html>